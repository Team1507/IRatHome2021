...
PurePursuit::PurePursuit( std::string profile_filename )
{
    ...
    m_profile_name = profile_filename;
...
{
    string   filename = PATH_TO_PROFILE + profile_filename + ".csv";
    ifstream openfile;
    string   line;
...
{
    cout<<" PP Init = " << m_profile_name << endl;
...
/*******************************
 ** PurePursuitGetProfileName
 *******************************/
std::string PurePursuit::PurePursuitGetProfileName(void)
{
